    ...
    $.extend(FancyBox.prototype, {
        ...
        updateControls : function ( force ) {
            ...
            if ( current.type === 'image' ) {
                ...
                /* Modified this line for different download sources */
                var imgSrcDownload =  current.opts.image.src || current.src;
                $container.find('[data-fancybox-download]').attr( 'href', imgSrcDownload.replace("-sm","")).show();
                $container.find('[data-fancybox-share]').attr( 'href', imgSrcDownload.replace("-sm","")).show();
...
;(function (document, $) {
	...
	$.extend(true, $.fancybox.defaults, {
		btnTpl : {
			share :
				'<a data-fancybox-share target="_blank" class="fancybox-button fancybox-button--share" title="{{SHARE}}">' +
					'<svg viewBox="0 0 40 40">' +
